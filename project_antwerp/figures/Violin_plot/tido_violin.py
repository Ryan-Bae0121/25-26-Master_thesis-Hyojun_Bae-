#!/usr/bin/env python3
"""
Tido violin plot - zeroshot_violin.py 와 완전히 동일한 스타일
tido_sample_gene_pcc_dist.npy 를 직접 로드
"""
...
# ── 데이터 로드
npy_path = Path('/project_antwerp/hbae/script/0208_start/0224_strat/tido_sample_gene_pcc_dist.npy')
...
title = f"Gene-wise PCC per Sample  (Top 300 genes · Tido Model · {n} samples)"
draw_violin(ax, sids, data, title)

plt.tight_layout()
plt.subplots_adjust(right=0.78)
out = Path('/project_antwerp/hbae/script/0208_start/Violin_plot/tido_violin.png')
